// This file contains legacy C API functions migrated from array.cpp.
// These functions are maintained for backward compatibility with external modules.
// Internal core callers have been updated to use C++ API directly.
